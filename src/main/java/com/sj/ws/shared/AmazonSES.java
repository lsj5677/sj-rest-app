...
public class AmazonSES {
	...
	final String FROM = "lsj5677@naver.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://localhost:8080/sj-rest-app-ui/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://localhost:8080/sj-rest-app-ui/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>" + "<p>Hi, $firstName!</p> "
			...
			+ "<a href='http://localhost:8080/sj-rest-app-ui/password-reset.html?token=$tokenValue'>"
	...
	final String PASSWORD_RESET_TEXTBODY = "A request to reset your password " + "Hi, $firstName! "
			...
			+ " http://localhost:8080/sj-rest-app-ui/password-reset.html?token=$tokenValue" + " Thank you!";
	...
	public void verifyEmail(UserDto userDto) {
		...
		// Make sure Regions should be the one where your verified email is registered
		// in AWS
